...
class Narrative:
    class RoleAssignment:
        ...
        hunter = (
            "You are the hunter. When you die, you may choose someone to kill somebody."
        )
    ...
    class InspectorReveal:
        ...
        cupid = RandLine(
            "When searching through %(target)s's belongings, you find a bizarre bow and arrow. Weirdo - and probably also cupid.",
    ...
    class Victory:
        ...
        wolves = RandLine(
            ...
            "Wolves win! Remaining wolves: %(wolves)s",
            "Wolves win! Remaining wolves: %(wolves)s. Help! I'm stuck in a #fullmoon writing factory!",
        )
        lovers = RandLine(
